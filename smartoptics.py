...
url_list = [
    'https://www.smartoptics.com/products/all/'
]
...
#    print(article)
#    print('-------------------------------------------------------------------------------')
    head = article.find('div', class_='heading-block')
    descr = article.find('div', class_='description-block')
#    print(head)
    href = head.find('a').get('href')
    title = head.find('a').string
#    print(title)
#    print(href)
#    print(descr)
    descript = descr.find('p').string
#    print(descript)
    print(title,descript,href,sep=';')
#    print('===============================================================================')
